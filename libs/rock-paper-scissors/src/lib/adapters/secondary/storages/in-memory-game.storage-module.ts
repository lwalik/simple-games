...
@NgModule({ imports: [],
  	declarations: [],
  	providers: [InMemoryGameStorage, { provide: SELECTS_GAME_CONTEXT, useExisting: InMemoryGameStorage }, { provide: PATCHES_GAME_CONTEXT, useExisting: InMemoryGameStorage }],
  	exports: [] })
