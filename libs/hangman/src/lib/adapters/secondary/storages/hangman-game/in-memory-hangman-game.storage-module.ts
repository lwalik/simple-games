...
@NgModule({ imports: [],
  	declarations: [],
  	providers: [InMemoryHangmanGameStorage, { provide: SETS_STATE_HANGMAN_GAME_CONTEXT, useExisting: InMemoryHangmanGameStorage }, { provide: PATCHES_HANGMAN_GAME_CONTEXT, useExisting: InMemoryHangmanGameStorage }, { provide: SELECTS_HANGMAN_GAME_CONTEXT, useExisting: InMemoryHangmanGameStorage }],
  	exports: [] })
